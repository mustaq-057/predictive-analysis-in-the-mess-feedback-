"""
Evaluate Multilingual Model (10k Samples)
...
def evaluate_model():
    print("🚀 Starting Multilingual Model Evaluation (10k Model)...")
    
    # 1. Load Model
    model_path = 'ml/models/sentiment_model_10k.pkl'
    vec_path = 'ml/models/sentiment_model_10k_vectorizer.pkl'
    ...
    test_cases = [
        ...
        {'text': 'service was pathetic', 'lang': 'English', 'expected': 'bad'},
        {'text': 'great atmosphere', 'lang': 'English', 'expected': 'good'}
    ]
    ...
    # Save results
    with open('ml/multilingual_10k_evaluation.txt', 'w') as f:
